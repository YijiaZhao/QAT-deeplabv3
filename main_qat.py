...
def build_sensitivity_profile(model, opts, testloader, device):
    ...
    for quant_layer, _ in quant_layer_sensitivity.items():
        ...
        res = val_score['Overall Acc'] + val_score['Mean Acc cls'] + val_score['Mean IoU'] + val_score['FreqW Acc']
        quant_layer_sensitivity2[quant_layer] = res

    print(quant_layer_sensitivity2)
        ...
        for (images, labels) in train_loader:
            ...
            if (cur_itrs) % opts.val_interval == 0:
                ...
                if val_score['Mean IoU'] > best_score:  # save best model
                    ...
                    onnx_model_name = 'onnx_models/' + str(val_score['Overall Acc']) + '_' + str(val_score['Mean Acc cls']) + '_' + str(val_score['Mean IoU']) + '_' + str(val_score['FreqW Acc']) + '.onnx'
